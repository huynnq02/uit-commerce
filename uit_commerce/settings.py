"""
Django settings for uit_commerce project.
...
SECRET_KEY = 'django-insecure-6lrzx#+4o$x7^a(dyuzsi%khg4#00wlmub^sp4p^gmnkuw7adj'
...
WSGI_APPLICATION = 'uit_commerce.wsgi.application'
